...
class FlashcardsViewModel(private val flashcardsDao: FlashcardsDao, private val application: Application): ViewModel() {
    ...
    private val _setModifyOption = MutableLiveData("")
    val setModifyOption: LiveData<String> get() = _setModifyOption
    fun setSetModifyOption(option: String) { _setModifyOption.value = option }
    fun toastSetModify(): Boolean { return setModifyOption.value != "" }
    fun setModifyAdd(): Boolean { return setModifyOption.value == SetsFragment.ADD_SET_TOAST }
    fun resetSetModifyOption() { _setModifyOption.value = "" }
