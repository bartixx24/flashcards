...
import com.example.flashcards.fragments.SetsFragment
...
import com.example.flashcards.viewmodel.FlashcardsViewModel.Companion.FLASHCARD_DEFINITION
import com.example.flashcards.viewmodel.FlashcardsViewModel.Companion.FLASHCARD_ID
import com.example.flashcards.viewmodel.FlashcardsViewModel.Companion.FLASHCARD_LEARNED
import com.example.flashcards.viewmodel.FlashcardsViewModel.Companion.FLASHCARD_TERM
import com.example.flashcards.viewmodel.FlashcardsViewModel.Companion.SET_ID
import com.example.flashcards.viewmodel.FlashcardsViewModel.Companion.SET_NAME
...
class FlashcardsViewModel(private val flashcardsDao: FlashcardsDao, private val application: Application): ViewModel() {
    ...
    fun getNextToLearn() {
        ...
        if(currentLearnIndex.value == learnFlashcards.value!!.size) {
            ...
            Log.d(TAG, "Shuffled: ${_nextLearnFlashcards.value!!.shuffled()}")
            if(_learnOption.value == learnOptions[2]) {
