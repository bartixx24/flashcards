...
class AppDataStore(context: Context) {
    ...
    val sortOptionPreferencesFlow: Flow<String> = context.dataStore.data
        ...
        .map { preferences -> preferences[SORT_OPTION] ?: context.resources.getStringArray(R.array.sort_options)[1] }
    ...
    val sortFlashcardsOptionPreferencesFlow: Flow<String> = context.dataStore.data
        ...
        .map { preferences -> preferences[SORT_FLASHCARDS_OPTION] ?: context.resources.getStringArray(R.array.learn_options)[1] }
